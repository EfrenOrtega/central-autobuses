...
public void tablaDiseño(){
        JTableHeader Header = tablaConductor.getTableHeader();
        ...
        tablaConductor.getColumnModel().getColumn(0).setCellRenderer(Alinear);
        tablaConductor.getColumnModel().getColumn(1).setCellRenderer(Alinear);
        tablaConductor.getColumnModel().getColumn(2).setCellRenderer(Alinear);
        tablaConductor.getColumnModel().getColumn(3).setCellRenderer(Alinear);
        tablaConductor.getColumnModel().getColumn(4).setCellRenderer(Alinear);
...
public void limpiarCajasText(){
    ...
    private void initComponents() {
        ...
        btoBuscar = new javax.swing.JLabel();
        ...
        jPanelMenu.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(86, 494, 105, 30));
        ...
        Asientos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Portada_Conductor.png"))); // NOI18N
        ...
        jLabel14.setText("ID:");
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(418, 260, -1, -1));

        txtID.setEditable(false);
        txtID.setBackground(new java.awt.Color(255, 255, 255));
        txtID.setForeground(new java.awt.Color(102, 102, 102));
        txtID.setBorder(null);
        jPanel1.add(txtID, new org.netbeans.lib.awtextra.AbsoluteConstraints(428, 284, 100, 25));

        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Caja Texto114.png"))); // NOI18N
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(418, 281, 114, 30));

        txtNombre.setToolTipText("");
        txtNombre.setBorder(null);
        jPanel1.add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(587, 284, 187, 25));

        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Caja Texto200.png"))); // NOI18N
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(577, 281, 200, 30));

        jLabelMatricula.setFont(new java.awt.Font("Roboto Medium", 0, 15)); // NOI18N
        jLabelMatricula.setText("Nombre:");
        jPanel1.add(jLabelMatricula, new org.netbeans.lib.awtextra.AbsoluteConstraints(577, 260, -1, -1));

        jLabelFechaNacimiento.setFont(new java.awt.Font("Roboto Medium", 0, 15)); // NOI18N
        jLabelFechaNacimiento.setText("Fecha de Nacimiento:");
        jPanel1.add(jLabelFechaNacimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(823, 260, -1, -1));

        jLabelAutobusAsignado.setFont(new java.awt.Font("Roboto Medium", 0, 15)); // NOI18N
        jLabelAutobusAsignado.setText("Telefono:");
        jPanel1.add(jLabelAutobusAsignado, new org.netbeans.lib.awtextra.AbsoluteConstraints(489, 354, -1, -1));

        txtDomicilio.setBorder(null);
        jPanel1.add(txtDomicilio, new org.netbeans.lib.awtextra.AbsoluteConstraints(671, 377, 262, 25));

        jLabel20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Caja Texto276.png"))); // NOI18N
        jPanel1.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(661, 375, 276, 30));

        jLabelHorario1.setFont(new java.awt.Font("Roboto Medium", 0, 15)); // NOI18N
        jLabelHorario1.setText("Domicilio:");
        jPanel1.add(jLabelHorario1, new org.netbeans.lib.awtextra.AbsoluteConstraints(661, 354, -1, -1));
        ...
        BoxFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-- Todos --", "ID", "Nombre", "Fecha Nacimiento", "Telefono", "Domicilio" }));
        jPanel1.add(BoxFiltro, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 520, 110, 30));

        tablaConductor.setBackground(new java.awt.Color(231, 247, 253));
        tablaConductor.setRowHeight(23);
        ...
        jPanel1.add(btoBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 524, -1, -1));

        txtTelefono.setBorder(null);
        jPanel1.add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(499, 377, 123, 25));

        jLabel25.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Caja Texto136.png"))); // NOI18N
        jPanel1.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(489, 375, 136, 30));

        jDateFecha.setBackground(new java.awt.Color(255, 255, 255));
        jDateFecha.setDateFormatString("yyyy-MM-dd");
        jPanel1.add(jDateFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(823, 281, 160, 30));
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
        Rutas Rut = new Rutas();
        this.setVisible(false);
        Rut.setVisible(true);    }//GEN-LAST:event_jLabel9MouseClicked
    ...
    private void tablaConductorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaConductorMouseClicked
        ...
        txtID.setText(String.valueOf(tablaConductor.getValueAt(registro, 0)));
        txtNombre.setText(String.valueOf(tablaConductor.getValueAt(registro, 1)));
        txtTelefono.setText(String.valueOf(tablaConductor.getValueAt(registro, 3)));
        txtDomicilio.setText(String.valueOf(tablaConductor.getValueAt(registro, 4)));

        SimpleDateFormat formato = new SimpleDateFormat("yyyy-MM-dd");
        String fecha;
        fecha = tablaConductor.getValueAt(tablaConductor.getSelectedRow(),2).toString().trim();
        Date fechaDate=null;
        try {
    ...
    private void btoBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btoBuscarMouseClicked
        ...
        if(!BoxFiltro.getSelectedItem().toString().equals("-- Todos --")){
            if(!txtBuscar.getText().equals("")){
                ...
                String sql;
                try{
                    sql="SELECT *FROM conductores WHERE " + Campo + " = ?";
                    ps = con.prepareStatement(sql);
                    ps.setString(1, Dato);
    ...
    }//GEN-LAST:event_btoBuscarMouseClicked
    ...
    private javax.swing.JLabel btoBuscar;
